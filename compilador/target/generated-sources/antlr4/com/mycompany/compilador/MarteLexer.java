...
public class MarteLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "SE", "SENAO", "ENQUANTO", "PARA", "PASSE", 
			"LEIA", "IMPRIMA", "INTEIRO", "DECIMAL", "BOOLEANO", "BOOL_LIT", "ID", 
			"NUMBER", "WS", "COMMENT", "MCOMMENT", "NUM"
		};
	}
	...
	public MarteLexer(CharStream input) {
		super(input);
